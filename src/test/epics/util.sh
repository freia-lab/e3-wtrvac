#+======================================================================
# $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/tags/CODAC-CORE-4.1.0/src/main/resources/util.sh $
# $Id: util.sh 38204 2013-06-13 20:36:07Z zagara $
#
