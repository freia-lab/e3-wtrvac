#!/bin/bash
#+======================================================================
# $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/tags/CODAC-CORE-4.1.0/src/main/resources/test.sh $
# $Id: test.sh 35402 2013-04-07 15:41:49Z zagara $
#
